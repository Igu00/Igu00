<div align="center">
  <h2>Olá, eu sou Desenvolvedor Backend 👋</h2>
  <p>Especialista em Automação Web, Web Scraping e desenvolvimento de APIs escaláveis.</p>
</div>
...
- **Selenium** (Manutenção de sistemas e automações legadas)
- **Anti-Detecção** (Scripts de bypass e contorno de WAFs e bloqueios em massa)
- Otimização extrema de navegadores instanciados em servidores (Headless).

**Infraestrutura e Mensageria**
- **AWS SQS** (Arquitetura orientada a eventos e mensageria distribuída)
- **Plataformas iPaaS / Low-Code** (Integrações nativas de gatilhos via Make.com / Webhooks)
- Controle de filas e paralelismo (asyncio, Multithreading, Semáforos lógicos).
...
Acredito que o código não termina quando a automação clica no botão com sucesso. Ele termina quando o erro não previsto na internet é encapsulado, gera um log estruturado compreensível, passa pelo webhook sem explodir a API e o servidor contínua consumindo as filas saudáveis perfeitamente.

Para isso utilizo:
- Logging JSON visando integração elástica com ferramentas de observabilidade e métricas de infra.
- Padrão **Fail-Fast** isolando dados e instâncias (como o uso mandatório do isolamento de contexto no Playwright em vez de abas compartilhadas de navegador).

---

<div align="center">
  <strong>Gostou do perfil? Estou sempre aberto para falar sobre engenharia de software e desafios de extração de dados modernos.</strong>
  <br><br>
  <!-- Sinta-se à vontade para adicionar seus links abaixo -->
  <a href="mailto:igoremanuelxd9@gmail.com">
    <img src="https://img.shields.io/badge/-Email-c14438?style=flat-square&logo=Gmail&logoColor=white" target="_blank">
  </a>
  <a href="LInkedin.com/in/igor-emanuel-3638b0213/">
